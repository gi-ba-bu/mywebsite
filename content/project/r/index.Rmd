...
The R code used in this study is displayed in code chunks below; the code output is rendered after each output command. In the next section, you will find:
