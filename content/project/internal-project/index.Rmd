...
## Comments on the linear regression
The linear regression analysis tells us a few things. First, the line of best has the following equation:

$$  y = 2.414 \cdot 10^3 - 3.073 \cdot 10^2 \cdot x $$

 - The variable $x$ stands for GDP per capita, while $y$ stands for deaths per million people. The $x$ coefficient tells us that for an increase in €10,000 of per-capita GDP, deaths are expected to reduce by 307 people.

 - The evidence for accepting this relationship is given by the very small p-value given for gdp_pp as evidenced in the linear regression summary statistics. The p-value is equal to 0.000265. In more technical terms, this means that we can confidently reject the null-hypothesis.

## The end

This analysis shows a strong relationship between the wealth of a country and its ability to protect its people from Covid-19. 

Finally, thank you for having a look at this page. I'll probably be adding to this analysis in the near future. 
