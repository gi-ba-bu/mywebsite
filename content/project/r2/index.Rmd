...
**Step 1)** Import the data. The data was previously downloaded to my laptop (on 18/08/2021) from the ECDC website, the European Centre for Disease prevention and Control.
```{r}
