...
data_long$Transport_type <- factor(data_long$Transport_type, levels=c("Total","Passenger.road.vehicles", "Road.freight.vehicles", "Aviation", "Shipping", "Other","Rail" ))
...
ggplot(data=data_long,  
  ...
  theme(legend.text = element_text(size = 36),
   ...
   scale_y_continuous(name = "Gigatons greenhouse gases", labels = comma) 
 ```
